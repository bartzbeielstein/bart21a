...
\author{\IEEEauthorblockN{Thomas Bartz-Beielstein}
...
\and
\IEEEauthorblockN{Marcel Dröscher}
\IEEEauthorblockA{\textit{Inst. Data Science, Engineering, and Analytics} \\
\textit{TH Köln}, Cologne, Germany \\
Marcel\_ulrich.droescher@smail.th-koeln.de}
\and
\IEEEauthorblockN{Alpar Gür}
\IEEEauthorblockA{\textit{Inst. Data Science, Engineering, and Analytics} \\
\textit{TH Köln}, Cologne, Germany \\
alpar.guer@smail.th-koeln.de}
\and
\IEEEauthorblockN{Alexander Hinterleitner}
\IEEEauthorblockA{\textit{dept. name of organization (of Aff.)} \\
\textit{TH Köln}, Cologne, Germany \\
Alexander.Hinterleitner@th-koeln.de}
\and
\IEEEauthorblockN{Olaf Mersmann}
\IEEEauthorblockA{\textit{Inst. Data Science, Engineering, and Analytics} \\
\textit{TH Köln}, Cologne, Germany \\
olaf.mersmann@th-koeln.de}
\and
\IEEEauthorblockN{Dessislava Peeva}
\IEEEauthorblockA{\textit{Inst. Data Science, Engineering, and Analytics} \\
\textit{TH Köln}, Cologne, Germany \\
dessislava\_todorova.peeva@smail.th-koeln.de}
\and
\IEEEauthorblockN{Lennard Reese}
\IEEEauthorblockA{\textit{Inst. Data Science, Engineering, and Analytics} \\
\textit{TH Köln}, Cologne, Germany \\
lennard.reese@smail.th-koeln.de}
\and
\IEEEauthorblockN{Nicolas Rehbach}
\IEEEauthorblockA{\textit{Inst. Data Science, Engineering, and Analytics} \\
\textit{TH Köln}, Cologne, Germany \\
nicolas\_alexander.rehbach@smail.th-koeln.de}
\and
\IEEEauthorblockN{Frederik Rehbach}
\IEEEauthorblockA{\textit{Inst. Data Science, Engineering, and Analytics} \\
\textit{TH Köln}, Cologne, Germany \\
frederik.rehbach@th-koeln.de}
\and
\IEEEauthorblockN{Amrita Sen}
\IEEEauthorblockA{\textit{Inst. Data Science, Engineering, and Analytics} \\
\textit{TH Köln}, Cologne, Germany \\
amrita.sen@gmx.de}
\and
\IEEEauthorblockN{Aleksandr Subbotin}
\IEEEauthorblockA{\textit{Inst. Data Science, Engineering, and Analytics} \\
\textit{TH Köln}, Cologne, Germany \\
aleksandr.subbotin@smail.th-koeln.de}
\and
\IEEEauthorblockN{Martin Zaefferer}
\IEEEauthorblockA{\textit{Inst. Data Science, Engineering, and Analytics} \\
\textit{TH Köln}, Cologne, Germany \\
